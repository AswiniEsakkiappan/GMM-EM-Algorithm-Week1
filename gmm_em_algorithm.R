...
cat("\nTRUE PARAMETERS:\n")
cat("Cluster 1 - Mean:", mu1_true, "\n")
cat("Cluster 1 - Sigma:\n")
print(sigma1_true)
cat("Cluster 2 - Mean:", mu2_true, "\n")
cat("Cluster 2 - Sigma:\n")
print(sigma2_true)

cat("\nESTIMATED PARAMETERS:\n")
cat("Mixing coefficients:", pi_k, "\n")
cat("Cluster 1 - Mean:", mu_k[1, ], "\n")
cat("Cluster 1 - Sigma:\n")
print(sigma_k[[1]])
cat("Cluster 2 - Mean:", mu_k[2, ], "\n")
cat("Cluster 2 - Sigma:\n")
print(sigma_k[[2]])

# Calculate accuracy
accuracy <- sum(true_clusters == clusters) / n
...
cat("  - Output/dataset.png\n")
cat("  - Output/final_clusters.png\n")
cat("  - Output/log_likelihood.png\n")
cat("  - Output/true_vs_estimated.png\n")

cat("\nSummary Statistics:\n")
cat("  - Total points:", n, "\n")
cat("  - Number of clusters:", K, "\n")
cat("  - Iterations until convergence:", length(logL_values), "\n")
cat("  - Final Log-Likelihood:", logL_values[length(logL_values)], "\n")
